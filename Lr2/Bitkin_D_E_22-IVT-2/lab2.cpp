  ...
  <<std::setw(15)<<std::setprecision(1)<<"assessed value:"<<"  |  "<<"\n";
	...
	std::string name;
		...
		std::cin>>name;
        	...
        	std::cout<< "Площадь здания: ";
       	surface=Secure<double>("Площадь здания: ");
        	...
        	year=Secure<int>("Год ввода в эксплуатацию: ") ;
        	
        	std::cout<<"Оценочная стоимость: ";
        	money=Secure<double>("Оценочная стоимость: ");
        	
        	struct airport a1(name,surface, floor, year, money);
         	
         	in <<std::fixed<<std::setw(30)<<std::setprecision(3)<<a1.get_name(&a1)<<"  |  "
...
std::cout<<"Вы выбрали режим работы : 'Справка'\n";
             		...
             		<<"Программа написана в качестве лабораторной работы №2 по Программированию\n"
